...
import 'package:projects/extensions/list/filter.dart';
import 'package:sqflite/sqflite.dart';
import 'package:path_provider/path_provider.dart'
    show getApplicationDocumentsDirectory;
import 'package:path/path.dart' show join;

import 'package:projects/services/crud/crud_exceptions.dart';
...
class DatabaseNote {
  ...
  @override
  String toString() =>
      'Note , ID = $id , userId = $userId , text = $text, isSyncedWhitCloud = $isSyncedWithCloud';
