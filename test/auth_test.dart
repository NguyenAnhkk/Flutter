...
void main() {
  group('Mock Authentication', () {
    ...
    test('Should be able ti be initialized', () async {
    ...
    test(
      'Should be able to initialized in less than 2 second',
      () async {
        await provider.initialize();
        expect(provider.isInitialized, true);
      },
    ...
    test('Logged is user should be able to get verified', (){
      provider.sendEmailVeritication();
...
class MockAuthProvider implements AuthProvider {
  ...
  Future<AuthUser> logIn({
    ...
    // test mong đợi email này sẽ throw UserNotLoggedInAuthExceptions
    if (email == 'foo@bar.com') throw UserNotLoggedInAuthExceptions();
